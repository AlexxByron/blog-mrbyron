...
function blog_mrbyron_scripts() {
	wp_enqueue_style( 'blog-mrbyron-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'blog-mrbyron-style', 'rtl', 'replace' );

	wp_enqueue_script( 'blog-mrbyron-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
